        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("Index", "MainPrestataire");
                    }
                    else if (roles.Contains("responsable_marche"))
                    {
                        return RedirectToAction("Index", "MainResponsable");
                    }
